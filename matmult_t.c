...
/*
 * multiply(): given a thread number, compute the appropriate element of the
 * product matrix C. The formulas for which rows and columns to multiply in
 * some ways dependent on the dimensions of the input arrays. After an element
 * is computed, the next thread is called.
 */
...
int main(int argc, char *argv[]) {
    ...
    getline(&line, &nbytes, fout); // space between input matrices
